    ...
    >
      <div className="flex flex-col gap-2 justify-center items-center w-full sm:w-[85%] m-auto">
        ...
        <p className="text-base sm:text-lg">
          I am open to internship opportunities to gain valuable experience in
          the technology field. If you are interested in collaborating or
          discussing further, please click the button below or send an email to{" "}
          <Link
            href={"mailto:wibowomulyooo@gmail.com"}
            className=" text-secondary-color-3 font-medium"
          >
            wibowomulyooo@gmail.com
          </Link>
          .
        </p>
