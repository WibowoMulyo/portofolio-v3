"use client";
import { schoolsInfo, schools } from "@/datas/data";
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              <h3 className="text-lg font-bold font-grotesk">
                {schoolsInfo[tab].title}
                {schoolsInfo[tab].school && (
                  <>
                    {" @"}
              ...
              <p className="text-base text-gray-500 mt-2 font-idgrotesk">
                {schoolsInfo[tab].location}
              </p>
              <h3 className="mt-2 text-gray-500 font-idgrotesk">
                {schoolsInfo[tab].duration}
              </h3>
